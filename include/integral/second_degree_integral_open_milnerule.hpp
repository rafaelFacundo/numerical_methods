...
public:
     ...
     */
    SecondDegreeIntegralOpenMilneRule(double xi, double deltax, std::function<double(double)> function, int numberOfPartitions);
     ...
     */
    SecondDegreeIntegralOpenMilneRule(double xi, double deltax, std::function<double(double)> function, double tolerance);
