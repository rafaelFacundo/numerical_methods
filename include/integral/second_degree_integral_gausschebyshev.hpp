...
class SecondDegreeIntegralGuassChebyShev : public IntegralGauss
{
public:
     ...
     */
    SecondDegreeIntegralGuassChebyShev(double xi, double xf, std::function<double(double)> function);
