...
public:
     ...
     */
    ThirdDegreeIntegralSimpsonThreeEighths(double xi, double deltax, std::function<double(double)> function, int numberOfPartitions);
     ...
     */
    ThirdDegreeIntegralSimpsonThreeEighths(double xi, double deltax, std::function<double(double)> function, double tolerance);
