...
class ThirdDegreeIntegralSimpsonThreeEighths : public Integral {
    public:
         ...
         */
        ThirdDegreeIntegralSimpsonThreeEighths(double xi, double deltax, std::function<double(int)> function, int numberOfPartitions);
         ...
         */
        ThirdDegreeIntegralSimpsonThreeEighths(double xi, double deltax, std::function<double(int)> function, double tolerance);
