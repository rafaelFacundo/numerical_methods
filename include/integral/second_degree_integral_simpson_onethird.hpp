...
class SecondDegreeIntegralSimpsonOnethird : public Integral
{
public:
    /**
     ...
     */
    SecondDegreeIntegralSimpsonOnethird(double xi, double deltax, std::function<double(double)> function, int numberOfPartitions);
     ...
     */
    SecondDegreeIntegralSimpsonOnethird(double xi, double deltax, std::function<double(double)> function, double tolerance);
