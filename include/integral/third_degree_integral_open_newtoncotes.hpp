...
class ThirdDegreeIntegralOpenNewtonCotes : public Integral
{
public:
    /**
     ...
     */
    ThirdDegreeIntegralOpenNewtonCotes(double xi, double deltax, std::function<double(double)> function, int numberOfPartitions);
     ...
     */
    ThirdDegreeIntegralOpenNewtonCotes(double xi, double deltax, std::function<double(double)> function, double tolerance);
