...
class ThirdDegreeIntegralOpenNewtonCotes : public Integral {
    public:
         ...
         */
        ThirdDegreeIntegralOpenNewtonCotes(double xi, double deltax, std::function<double(int)> function, int numberOfPartitions);
         ...
         */
        ThirdDegreeIntegralOpenNewtonCotes(double xi, double deltax, std::function<double(int)> function, double tolerance);
