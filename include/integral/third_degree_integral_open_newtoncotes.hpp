...
class ThirdDegreeIntegralOpenNewtonCotes : public Integral {
    public:
         ...
         */
        ThirdDegreeIntegralOpenNewtonCotes(double xi, double deltax, functionWithOneArgument function, int numberOfPartitions);
         ...
         */
        ThirdDegreeIntegralOpenNewtonCotes(double xi, double deltax, functionWithOneArgument function, double tolerance);
