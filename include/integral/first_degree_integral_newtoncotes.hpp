...
class FirstDegreeIntegralNewtonCotes : public Integral
{
public:
  /**
   ...
   */
  FirstDegreeIntegralNewtonCotes(double xi, double deltax, std::function<double(double)> function, int numberOfPartitions);
   ...
   */
  FirstDegreeIntegralNewtonCotes(double xi, double deltax, std::function<double(double)> function, double tolerance);
