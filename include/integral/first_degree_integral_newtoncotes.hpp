...
class FirstDegreeIntegralNewtonCotes : public Integral {
    public:
         ...
         */
        FirstDegreeIntegralNewtonCotes(double xi, double deltax, std::function<double(int)> function, int numberOfPartitions);
         ...
         */
        FirstDegreeIntegralNewtonCotes(double xi, double deltax, std::function<double(int)> function, double tolerance);
