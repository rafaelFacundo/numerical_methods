...
class FirstDegreeIntegralOpenNewtonCotes : public Integral {
    public:
         ...
         */
        FirstDegreeIntegralOpenNewtonCotes(double xi, double deltax, std::function<double(int)> function, int numberOfPartitions);
         ...
         */
        FirstDegreeIntegralOpenNewtonCotes(double xi, double deltax, std::function<double(int)> function, double tolerance);
