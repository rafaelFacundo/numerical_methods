...
class FirstDegreeIntegralOpenNewtonCotes : public Integral
{
public:
    /**
     ...
     */
    FirstDegreeIntegralOpenNewtonCotes(double xi, double deltax, std::function<double(double)> function, int numberOfPartitions);
     ...
     */
    FirstDegreeIntegralOpenNewtonCotes(double xi, double deltax, std::function<double(double)> function, double tolerance);
